        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-5">
            <div class="widget-content widget-content-area br-6">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    ...
                    <h4 class="mb-0 text-center flex-grow-1">Edit Category</h4>
                ...
                <form action="{{ route('admin.category.update', $category->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block py-3" title="Update Category">
                            <i class="fas fa-plus-circle mr-2"></i> Update Category
                        </button>
                    </div>
                </form>
            </div>
