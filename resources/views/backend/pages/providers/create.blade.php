        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-5">
            <div class="widget-content widget-content-area br-6">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    ...
                    <h4 class="mb-0 text-center flex-grow-1">Create New Provider</h4>
                ...
                <form action="{{ route('admin.providers.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="input-group password-toggle">
                            <input type="password" class="form-control" id="password_confirmation"
                                name="password_confirmation" placeholder="Confirm Provider password">
                            <div class="input-group-append">
                                <span class="input-group-text bg-transparent">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block py-3" title="Create Provider">
                            <i class="fas fa-plus-circle mr-2"></i> Create Provider
                        </button>
                    </div>
                </form>
            </div>
