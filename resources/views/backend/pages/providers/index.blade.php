...
@section('content')
    <div class="row align-items-center my-4">
        <div class="col-md-6">
            <h3 class="mb-0 font-weight-bold">Providers</h3>
        </div>
        <div class="col-md-6 text-md-right">
            <a href="{{ route('admin.providers.create') }}" class="btn btn-primary px-4">
