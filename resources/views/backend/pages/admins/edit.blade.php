        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-5">
            <div class="widget-content widget-content-area br-6">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    ...
                    <h4 class="mb-0 text-center flex-grow-1">Edit Admin</h4>
                ...
                <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block py-3" title="Update Admin">
                            <i class="fas fa-plus-circle mr-2"></i> Update Admin
                        </button>
                    </div>
                </form>
            </div>
