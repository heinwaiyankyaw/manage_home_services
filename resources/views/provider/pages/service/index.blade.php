...
@section('content')
    <div class="row align-items-center my-4">
        <div class="col-md-6">
            <h3 class="mb-0 font-weight-bold">Services</h3>
        </div>
        <div class="col-md-6 text-md-right">
            <a href="{{ route('provider.services.create') }}" class="btn btn-primary px-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm edit-btn" title="Edit"
                                            data-edit-url="{{ route('provider.services.edit', $service->id) }}">
                                            <i class="fas fa-edit"></i>
                                        </button>

                                        <form action="{{ route('provider.services.delete', $service->id) }}" method="POST"
