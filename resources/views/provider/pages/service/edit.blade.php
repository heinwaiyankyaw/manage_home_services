    ...
    <div class="row" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-5">
            <div class="widget-content widget-content-area br-6">
                ...
                <form action="{{ route('provider.services.update', $service->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="form-group mb-4 col-md-6">
                            <label for="name">Name</label>
                            <input type="text" class="form-control" id="name" name="name"
                                value="{{ $service->name }}" placeholder="Enter Service name">
                            @error('name')
                        ...
                        <div class="form-group mb-4 col-md-6">
                            ...
                            <input type="text" class="form-control" id="price" name="price"
                                value="{{ $service->price }}" placeholder="Enter Service price">
                            @error('price')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" id="duration" name="duration"
                            value="{{ $service->duration }}" placeholder="Enter Service duration">
                        @error('duration')
                            <div class="text-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group mb-4 col-md-6">
                            <label for="stak;tus">Category</label>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block py-3" title="Update Service">
                            <i class="fas fa-plus-circle mr-2"></i> Update Service
                        </button>
                    </div>
                </form>
            </div>
