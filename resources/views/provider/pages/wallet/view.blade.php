        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-5">
            <div class="widget-content widget-content-area br-6">
                <div class="d-flex justify-content-center align-items-center mb-4">
                    ...
                    <h4 class="mb-0 text-center flex-grow-1">Edit Wallet</h4>
                    <div style="width: 80px;"></div>
                </div>
                <form action="{{ route('provider.wallets.update', $wallet->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-4">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter Wallet name" value="{{ old('name', $wallet->name) }}">
                        @error('name')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="file" class="form-control shadow-sm" id="img" name="img" accept="image/*"
                    ...
                    <div class="form-group mb-4" style="display: none;" id="newPreviewSec">
                        <label class="form-label font-weight-bold">New Image Preview</label>
                        <div class="border p-3 rounded bg-light text-center">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-block py-3" title="Update Wallet">
...
@section('scripts')
    <script>
        function previewImage(event) {
            ...
            const newPreviewSec = document.getElementById('newPreviewSec');
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    newPreviewSec.style.display = 'block';
                ...
                imgPreview.src = '#';
                newPreviewSec.style.display = 'none';
